...
parser.add_argument('--anno', default='train_annotations',
                    help='mscoco annotation set (one of val2017, train2017, test-dev2017)')
parser.add_argument('--dataset', default='vdot', type=str, metavar='DATASET',
                    help='Name of dataset (default: "coco"')
parser.add_argument('--split', default='val',
                    help='validation split')
parser.add_argument('--model', '-m', metavar='MODEL', default='tf_efficientdet_d0',
                    help='model architecture (default: tf_efficientdet_d0)')
...
def validate(args):
    ...
    annotation_path = os.path.join(args.data, 'train_annotations', f'{args.anno}.json')
    image_dir = os.path.join(args.data, 'train_set')
